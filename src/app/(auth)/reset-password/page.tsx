          ...
          <CardHeader className="pb-2 pt-6">
            <div className="flex items-center justify-center gap-2 mb-1">
              <div className="h-8 w-8 rounded-full bg-[#EFF6FF] flex items-center justify-center">
                <KeyRound className="h-4 w-4 text-[#01A0FF]" />
              </div>
            </div>
          ...
          <CardContent className="pt-4 pb-6">
            {success ? (
              <div className="text-center py-4">
                ...
                <p className="text-[14px] font-medium text-[#253859]">Password updated!</p>
                <p className="text-[12px] text-[#94A3B8] mt-1">Redirecting you now...</p>
              </div>
            ) : (
              <form onSubmit={handleReset} className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="confirmPassword" className="text-[12px] font-medium text-[#717D93] uppercase tracking-wider">
                    Confirm Password
                  </Label>
                  <Input
                    id="confirmPassword"
